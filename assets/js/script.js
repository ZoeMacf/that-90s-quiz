...
let questions = [
    {
        ...
        options: ["Foo Fighters", "Weezer", "Red Hot Chili Peppers", "Blink-182"],
        answer: 2 
    },

    {
        ...
        options: ["Lemurs", "Monkeys", "Frogger", "Lemmings"],
        answer: 3
    },

    {
        question: "Who played the title character in the 1990s TV show “Buffy the Vampire Slayer”?",
        options: ["Sarah Michelle Gellar", "Jennifer Love Hewitt", "Alicia Silverstone", "Melissa Joan Hart"],
        answer: 0
    },

    {
        question: "What was the highest-grossing film of the 1990s?",
        options: ["Shawshank Redemption", "Titanic", "The Bodygyard", "Braveheart"],
        answer: 1
    },

    {
        ...
        options: ["Age of Empires", "SimCity", "Myst", "Civilization"],
        answer: 3
    }
]
